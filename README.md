...
**3. Author: Ömer Sakarya**
   * [URL](https://towardsdatascience.com/selenium-tutorial-scraping-glassdoor-com-in-10-minutes-3d0915c6d905)
   - Guide used for explaining how the scraper works.
   
**4. Author: Chris I.**
   * [URL](https://towardsdatascience.com/productionize-a-machine-learning-model-with-flask-and-heroku-8201260503d2)
